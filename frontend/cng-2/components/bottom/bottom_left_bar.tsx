...
import { Select, MenuItem, Box, IconButton, Typography, Button, FormControl, InputLabel, Input, InputAdornment } from '@mui/material';
...
export function BottomLeftBar({ onDropdownDateChange, onAddSchedule }) {
  ...
  <div className="flex items-center justify-between h-12 px-2 py-2 bg-brand-BDC3C0 border-b z-1">    
    <div className="flex items-center space-x-2">
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', borderRadius: "10px", backgroundColor: "#e6ebe9" }}>
        <Button onClick={() => {}} className="flex items-center gap-1" sx={styleHover2}>
      ...
      <IconButton onClick={onAddSchedule} className="flex items-center gap-1" sx={styleHover}>
